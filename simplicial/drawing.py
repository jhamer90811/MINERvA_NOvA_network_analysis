...
def draw_complex( c, em, ax = None, color = None, color_simplex = None, node_size = 0.02,xlims = [-0.2,1.2],
                  ylims = [-0.2,1.2]):
    ...
    :param xlims: the min/max x-values of the viewing window
    :param ylims: the min/max y-values of the viewing window
    '''
    ...
    # set up the axes
    ax.set_xlim([xlims[0], xlims[1]])      # axes bounded around 1
